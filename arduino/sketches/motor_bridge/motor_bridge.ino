...
ros::Publisher motor_left("/left_wheel1/state", &motor_left_speed);
ros::Publisher motor_right("/right_wheel1/state", &motor_right_speed);

// Velocity subscribers
ros::Subscriber<std_msgs::Float64> motor_left_controller("/left_wheel1/control_effort", &set_left_speed );
ros::Subscriber<std_msgs::Float64> motor_right_controller("/right_wheel1/control_effort", &set_right_speed);
